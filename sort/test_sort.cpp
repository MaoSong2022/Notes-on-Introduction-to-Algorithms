...
//    Sort::heap_sort<int, std::greater<int>>(array); // decreasing order, big root
    ...
    array = {5, 4, 3, 8, 6, 2, 1, 9, 7, 0};
    std::cout << "The original array: " << std::endl;
    output_array(array);
//    Sort::quick_sort(array); // increasing order, small root
    Sort::quick_sort<int, std::greater<int>>(array); // decreasing order, big root
    std::cout << "The array after " << "quick sort" << std::endl;
    output_array(array);
